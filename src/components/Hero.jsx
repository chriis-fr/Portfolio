...
const Hero = () => {
  return (
    <section className='relative w-full p-48 mx-auto justify-center items-center flex'>
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-4`}>
        ...
        <div >
             <h1 className={`${styles.heroHeadText} tet-whote`}
             // eslint-disable-next-line react/no-unescaped-entities 
             >Hey🙋🏾‍♂️,&nbsp; I'm <span className='text-[#915eff]'>Chris</span></h1>
             <p className={`${styles.heroSubText} mt-2 text-white-100`}>
              A Full Stack Web2 and Web3 blockchain developer 
             </p>
          </div>
      </div>
      ...
      <div className='absolute xs:bottom-10 bottom-1 flex-1 justify-center items-center'>
        <a href='#about'>
